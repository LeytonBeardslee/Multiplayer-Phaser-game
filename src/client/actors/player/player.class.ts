    export class Player {
        ...
        constructor(private gameInstance: any, public
        playerInstance: any) {
        ...
        this.player.animations.add('accelerating',
        ...
        this.playerState.set('ammo', this.projectile.
        ...
        gameInstance.physics.enable(this.player, Phaser.
        ...
        40
        The Game Model
        Our little spaceship needs a world
